...
function spawn(counter, ctx, bX) {
  if (counter % 40 === 0) {
    ...
    if (counter * 1.5 < 1000) {
      ...
      arr.push(new _obstacles2.default(bX, 0, 140, 4, 8.5, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * (counter % 12 + 2), 0, 280, 6, 9.5, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * Math.floor(counter % 14), 0, 280, 10, 10, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * (counter % 33), 0, 330, 12, 10, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * Math.floor(counter % 89 / 10), -100, 180, 14, 11, ctx, '#000000'));
    } else {
      arr.push(new _obstacles2.default(bX, 0, 140, 4, 8, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * (counter % 5), 0, 280, 10, 10, ctx, randomColor));
      arr.push(new _obstacles2.default(bX * (counter % 63), 0, 280, 15, 12, ctx, '#000000'));
      ...
      arr.push(new _obstacles2.default(bX * Math.floor(counter % 164 / 25), -100, 180, 20, 20, ctx, '#000000'));
    }
  }
}
